...
require 'auth.php';
 ...
 if(isset($_POST['titre']) && isset($_POST['stitre']) && isset($_POST['contenue']) && isset($_POST['date']) ) 
 {
// Checking the file was submitted
        if(empty($_POST['titre']) || empty($_POST['stitre']) || empty($_POST['contenue']) || empty($_POST['date'])  ) 
        {
                echo '<script>
                window.location.replace("event.php?msg=data_inv");
                </script>';
        } else {
        }
 }
...
(titre,	sous_titre,	description, image, created) 
VALUES
('".$_POST['titre']."','".$_POST['stitre']."','".$_POST['contenue']."','".$imgData."','".$_POST['date']."');";
...
echo '<script>
window.location.replace("event.php?msg=ok");
</script>';
...
echo '<script>
window.location.replace("event.php?msg='.$msg.'");
</script>';
}
return $msg;
}
